...
export default function Footer() {
    return (
        <footer className='bg-periwinkle text-white h-fit pt-3 pb-1'>
            ...
            <Link href={`https://wa.me/9151705010?text=Hi%20there%2C%20I%20am%20looking%20for%20tour%20packages%2Fcab%20services.%0Ahttps%3A%2F%2Fwww.vanshikatour.in%2F`} target='_blank'><WhatsAppIcon/></Link>
            </div>
